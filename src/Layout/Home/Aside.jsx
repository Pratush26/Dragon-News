        ...
        <aside className="space-y-4">
            <section className="space-y-4">
                ...
                <div className="grid grid-flow-row gap-2">
                    <button className="flex items-center justify-center gap-3 rounded-sm border border-sky-400 px-4 py-2 text-sm font-medium hover:text-sky-400 cursor-pointer"><FcGoogle /> Login with Google</button>
                    <button className="flex items-center justify-center gap-3 rounded-sm border border-sky-400 px-4 py-2 text-sm font-medium hover:text-sky-400 cursor-pointer"><FaGithub /> Login with Github</button>
                </div>
